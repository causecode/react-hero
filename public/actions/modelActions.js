...
exports.clearInstanceDataError = function (resource) {
    return {
        type: constants_1.CLEAR_INSTANCE_DATA_ERROR,
        payload: resource,
    };
};
exports.clearInstanceListError = function (resource) {
    return {
        type: constants_1.CLEAR_INSTANCE_LIST_ERROR,
        payload: resource,
    };
};
