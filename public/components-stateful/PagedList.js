    ...
    function PagedListImpl(props) {
        ...
        _this.renderDataGrid = function () {
            if (!_this.props.dataGrid) {
                return (React.createElement(DataGrid_1.DataGrid, { instanceList: _this.props.instanceList, properties: _this.props.properties, handleRecordDelete: _this.props.handleRecordDelete, totalCount: _this.props.totalCount, showDefaultActions: _this.props.showDefaultActions, customActions: _this.props.customActions }));
            }
            if (typeof _this.props.dataGrid === 'function') {
                var CustomDataGrid = _this.props.dataGrid;
                return (React.createElement(CustomDataGrid, { instanceList: _this.props.instanceList, properties: _this.props.properties, handleRecordDelete: _this.props.handleRecordDelete, totalCount: _this.props.totalCount }));
            }
