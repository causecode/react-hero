...
export declare class EditPageImpl extends React.Component<EditPageProps, void> {
    ...
    handleSubmit: (instance: BaseModel, successCallBack?: (any: any) => {}, failureCallBack?: (any: any) => {}) => void;
    handleDelete: (instance: BaseModel, successCallBack?: (any: any) => {}, failureCallBack?: (any: any) => {}) => void;
