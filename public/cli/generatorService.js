...
function getEditPage(pageType) {
    ...
    var filePath = projectConfig_1.projectRoot + "/src/components/" + resourceName + "/" + fileName;
...
function getListPage() {
    ...
    var resourceName = ModelClass.resourceName;
    TemplateService.writeFile(path.join(__dirname, projectConfig_1.projectRoot + "/src/components/" + resourceName + "/" + resourceName.capitalize() + "List.tsx"), TemplateService.getListPage(ModelClass), function () { });
...
function getShowPage() {
    ...
    var resourceName = ModelClass.resourceName;
    TemplateService.writeFile(path.join(__dirname, projectConfig_1.projectRoot + "/src/components/" + resourceName + "/" + resourceName.capitalize() + "Show.tsx"), TemplateService.getShowPage(ModelClass), function () { });
