...
var GenericInputTemplate = function (props) {
    ...
    return (React.createElement("input", __assign({ type: props.type, className: "form-control", defaultValue: props.propertyValue }, inputProps)));
};
var BooleanInputTemplate = function (props) {
    ...
    return (React.createElement(react_bootstrap_1.Row, null,
        React.createElement(react_bootstrap_1.Col, { sm: 6 },
            React.createElement(react_bootstrap_1.Radio, { onChange: handleChange, value: "option-true", name: props.propertyName, checked: props.propertyValue }, props.radioButtonLabels && props.radioButtonLabels.first ? props.radioButtonLabels.first : 'True')),
        React.createElement(react_bootstrap_1.Col, { sm: 6 },
            React.createElement(react_bootstrap_1.Radio, { onChange: handleChange, value: "option-false", name: props.propertyName, checked: !props.propertyValue }, props.radioButtonLabels && props.radioButtonLabels.second
...
var FormInputImpl = (function (_super) {
    ...
    FormInputImpl.prototype.render = function () {
        ...
        return (React.createElement(react_bootstrap_1.FormGroup, { className: "row", style: { margin: '0px' } },
            React.createElement(react_bootstrap_1.Col, { sm: this.props.labelSize },
                React.createElement(react_bootstrap_1.ControlLabel, { style: { textAlign: 'right' } }, this.props.propertyName)),
            React.createElement(react_bootstrap_1.Col, { sm: this.props.fieldSize, style: this.props.style },
