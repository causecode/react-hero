...
var BooleanInputTemplate = function (props) {
    ...
    return (React.createElement(react_bootstrap_1.Row, null,
        React.createElement(react_bootstrap_1.Col, { sm: 6 },
            React.createElement(react_bootstrap_1.Radio, { onChange: handleChange, value: "option-true", name: props.propertyName, checked: props.propertyValue }, props.radioButtonLabels.first || 'True')),
        React.createElement(react_bootstrap_1.Col, { sm: 6 },
            React.createElement(react_bootstrap_1.Radio, { onChange: handleChange, value: "option-false", name: props.propertyName, checked: !props.propertyValue }, props.radioButtonLabels.second || 'False'))));
};
