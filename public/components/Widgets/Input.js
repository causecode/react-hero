...
var GenericInputTemplate = function (props) {
    ...
    return (React.createElement("input", { type: props.type, className: "form-control", value: props.value, onChange: handleChange }));
};
...
var DropDownInputTemplate = function (props) {
    ...
    return (React.createElement("select", { value: props.propertyValue, className: "form-control", onChange: handleChange },
        React.createElement("option", { disabled: true, value: "", style: {
                color: 'grey',
                pointerEvents: 'none'
            } }, "Select one.."),
        (function () {
            ...
            return Object
                .keys(enumInstance)
                .map(function (enumproperty, index) {
                if (enumInstance.hasOwnProperty(enumproperty) && !isNaN(parseInt(enumproperty, 10))) {
                    return (React.createElement("option", { key: enumInstance[enumproperty] + "-" + index, value: enumproperty }, enumInstance[enumproperty]));
                }
            });
        })()));
};
...
var FormInputImpl = (function (_super) {
    ...
    function FormInputImpl() {
        ...
        _this.handleChange = function (newValue) {
            store_1.store.dispatch(actions.change(_this.props.model, newValue));
        };
...
exports.FormInput = react_redux_1.connect(mapStateToProps)(FormInputImpl);
