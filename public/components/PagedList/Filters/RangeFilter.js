...
function RangeFilter(_a, _b) {
    ...
    return (React.createElement(react_bootstrap_1.FormGroup, null,
        ...
        React.createElement(react_bootstrap_1.FormControl, __assign({ type: "text" }, fields[0])),
        React.createElement("strong", null, "To"),
        React.createElement(react_bootstrap_1.FormControl, __assign({ type: "text" }, fields[1]))));
}
