...
var DataGridImpl = (function (_super) {
    ...
    function DataGridImpl() {
        ...
        _this.renderCount = function () {
            var _a = _this.props, max = _a.max, offset = _a.offset, totalCount = _a.totalCount;
            if (!max || !totalCount) {
                return null;
            }
            return (React.createElement("tr", { id: "totalCount" },
                React.createElement("td", { colSpan: _this.properties.length + 3 },
                    "Showing ",
                ...
                React.createElement("tbody", null,
                    this.props.instanceList.map(function (instance, index) {
                        ...
                        return (React.createElement("tr", { key: index, className: "data-grid-row" },
                            ...
                            React.createElement("td", null, listIndex++),
