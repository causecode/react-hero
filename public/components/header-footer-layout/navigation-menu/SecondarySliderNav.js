...
var SecondarySliderNav = (function (_super) {
    ...
    SecondarySliderNav.prototype.render = function () {
        return (React.createElement(SliderNav_1.SliderNav, { navStyle: [navStyle, this.props.style], isPrimaryNav: false, navContent: this.props.children, onSecondaryNavClose: this.props.onNavClose }));
    };
