...
var PrimarySliderNav = (function (_super) {
    ...
    PrimarySliderNav.prototype.render = function () {
        return (React.createElement(SliderNav_1.SliderNav, { navStyle: [navStyle, this.props.style], isPrimaryNav: true, navContent: this.props.children, onPrimaryNavClose: this.props.onNavClose }));
    };
