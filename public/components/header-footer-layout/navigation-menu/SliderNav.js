...
var SliderNavImpl = (function (_super) {
    ...
    SliderNavImpl.prototype.render = function () {
        var _this = this;
        var _a = this.props, isPrimaryNav = _a.isPrimaryNav, toggleNavHandler = _a.toggleNavHandler, toggleSecondaryNavHandler = _a.toggleSecondaryNavHandler, navStyle = _a.navStyle, onPrimaryNavClose = _a.onPrimaryNavClose, onSecondaryNavClose = _a.onSecondaryNavClose;
        ...
        var motion = React.createElement(react_motion_1.Motion, { style: { x: react_motion_1.spring(this.props[isPrimaryNav ? 'primaryNavOpen' : 'secondaryNavOpen'] ?
            ...
            return React.createElement("div", { className: navMenuClasses, style: [
                ...
                React.createElement("i", { className: closeButtonClasses, onClick: isPrimaryNav ?
                        (onPrimaryNavClose || toggleNavHandler) :
                        (onSecondaryNavClose || toggleSecondaryNavHandler) }),
