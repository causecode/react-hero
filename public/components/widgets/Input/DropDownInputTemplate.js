...
exports.DropDownInputTemplate = function (props) {
    var handleChange = function (e) {
        if (e.constructor === Array) {
            props.onChange(e.map(function (item) { return item.value; }));
        }
        else {
            props.onChange(e.value);
        }
    };
    var multi = props.multi, creatable = props.creatable, autoBlur = props.autoBlur, autofocus = props.autofocus, propertyValue = props.propertyValue, options = props.enum, style = props.style;
    var selectProps = {
        multi: multi || false,
