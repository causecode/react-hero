...
function generateForm(instance, isCreatePage, model, propTypes) {
    ...
    return (React.createElement("div", null, Object.keys(propTypes).map(function (prop, index) {
        ...
        var formModelString = isCreatePage ? instance.resourceName + "Create" : instance.resourceName + "Edit";
        ...
        return (React.createElement(Widgets_1.FormInput, { type: instance.propTypes[prop].type, enum: instance.propTypes[prop].enum, key: "form-control-" + instance.resourceName + "-" + index, propertyName: prop, model: modelString }));
    })));
}
