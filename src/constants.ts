...
export const CLEAR_INSTANCE_DATA_ERROR: string = 'CLEAR_INSTANCE_DATA_ERROR';
export const CLEAR_INSTANCE_LIST_ERROR: string = 'CLEAR_INSTANCE_LIST_ERROR';
...
export const SHOW_PRIMARY_NAV = 'SHOW_PRIMARY_NAV';
export const SHOW_SECONDARY_NAV = 'SHOW_SECONDARY_NAV';
