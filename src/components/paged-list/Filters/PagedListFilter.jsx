...
var PagedListFilters = (function (_super) {
    ...
    function PagedListFilters() {
        ...
        _this.componentWillMount = function () {
            InnerFilterForm = DynamicForm_1.createFilterForm(_this.props.resource);
        };
    ...
    PagedListFilters.prototype.render = function () {
        ...
        return (<div className="paged-list-filters">
                <react_bootstrap_1.Button onClick={this.toggleFilters}>
                    <FontAwesome name="filter"/>
                </react_bootstrap_1.Button>
                <InnerFilterForm resource={this.props.resource} path={this.props.path} filtersOpen={false} successCallBack={this.props.successCallBack} failureCallBack={this.props.failureCallBack}>
                    {children}
                </InnerFilterForm>
            </div>);
    };
