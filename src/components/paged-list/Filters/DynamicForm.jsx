...
var InnerFilterFormImpl = (function (_super) {
    ...
    InnerFilterFormImpl.prototype.render = function () {
        ...
        return (<form className={classNames('form-inline', 'filter-form', 'stick-left', hideClass)} onSubmit={this.handleSubmit}>
                {this.props.children}
                <react_bootstrap_1.Button className="filter-button" bsStyle="primary" type="submit">Submit</react_bootstrap_1.Button>
            </form>);
    };
