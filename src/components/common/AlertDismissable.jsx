...
var AlertDismissableImpl = (function (_super) {
    ...
    AlertDismissableImpl.prototype.render = function () {
        ...
        return (<ReusableComponents_1.Alert style={this.props.alertStyle || alertStyle} bsStyle={this.props.type} onDismiss={commonUtils_1.hideAlert}>
                <strong>
                    <span style={this.props.alertFontStyle || fontStyle}>{this.props.message}</span>
                </strong>
            </ReusableComponents_1.Alert>);
    };
