...
describe('Markdown and RawContent Wrapper test cases', (): void => {
    ...
    unroll('Component should contain #selector element', (
        ...
        args: {
            key: ShallowWrapper<IRawContentProps | IMarkdownProps, void>,
    ...
    describe('When the component is connected to redux store', (): void => {
        ...
        unroll('it should render #componentName', (
            done: () => void,
            args: {
                componentName: string,
                component: ReactWrapper<IRawContentProps, void>,
                innerComponent: React.ComponentClass<any>
            }):
            void => {
